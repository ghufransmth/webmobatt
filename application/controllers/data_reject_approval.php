...
class Data_reject_approval extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('page/data_approval_reject/index.php');
	...
	public function index_absensi()
	{
		$this->load->view('style.php');
		$this->load->view('menu_header.php');
		$this->load->view('page/data_approval_reject/index_absensi.php');
		$this->load->view('footer.php');
	}
	public function index_lembur()
	{
		$this->load->view('style.php');
		$this->load->view('menu_header.php');
		$this->load->view('page/data_approval_reject/index_lembur.php');
		$this->load->view('footer.php');
	}
