...
foreach($data as $val){
	...
	$file_slip_gaji=$val['file_slip_gaji'];
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo base_url(); ?>/index.php/data_slip_gaji/index"><i class="fa fa-money"></i> Data Slip Gaji </a></li>
            <li class="active">Edit Data Slip Gaji </li>
          </ol>
        </section>
        <!-- Main content -->
						...
						<div class="box-body">
							...
							<div class="col-md-6">
									<input type="hidden" name="id" value="<?php echo $id; ?>"class="form-control" id="user_id" >
										<input type="hidden" name="file_slip_gaji_db" value="<?php echo $file_slip_gaji; ?>"class="form-control" id="user_id" >
									...
									<div class="form-group">
										...
										<input type="file" name="file_slip_gaji" id="file_slip_gaji" class="form-control" >
							...
							<table class="table table-bordered" style="text-align:center">
								<tr>
									<td><a href="<?php echo base_url(); ?>/upload/upload_slip_gaji/<?php echo $file_slip_gaji; ?>" target="_blank">DOWNLOAD</td>
								</tr>
							</table>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_slip_gaji/edit_data_slip_gaji',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
					...
					success:function (data){
							...
							sweetAlert({
	                                                   title: "Berhasil!", 
														...
														, function() {
																	location.href='<?php echo base_url(); ?>index.php/data_slip_gaji/index';
														}
														);
