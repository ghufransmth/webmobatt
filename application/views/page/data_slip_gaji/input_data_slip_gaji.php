						...
						<div class="box-body">
							...
							<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="file" name="file_slip_gaji" id="file_slip_gaji" class="form-control" required>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_slip_gaji/save_data_slip_gaji',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
...
<script>
            ...
            $.ajax({
                ...
                contentType : false,
                success:function (data_master_equipment){
						$('#nama_pegawai').append('<option value="">--Pilih Nama Pegawai--</option>');
                    $.each(data_master_equipment.data, function(i, item){
