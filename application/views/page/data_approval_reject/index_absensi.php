    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            DATA ABSENSI SUDAH DISETUJUI
          </h1>
          <ol class="breadcrumb">
             <li><a href="<?php echo base_url() ?>index.php/home"><i class="fa fa-home"></i> Home</a></li>
           <li class="active">Data Absensi Sudah Disetujui </li>
          </ol>
        </section>
	...
	<script>
		$(document).ready(function(){ 
			$("#data-brands").dataTable({
					...
					"bAutoWidth": false,
					"processing": true,
					"ajax": '<?php echo base_url() ?>/index.php/data_absensi/get_data_absensi_approval_reject',
					"columns": [
						...
						{ "data": "id", 
						"render" : function(data){
							return '<a href="#"><button type="button" onclick="delete_master_shoes_category('+data+')" class="btn btn-danger btn-sm" style="border-radius:0px;" ><i class="fa fa-undo"></i></button></a>'
						}}
					]
			});
	...
	<script>
		function delete_master_shoes_category(id){
	swal({   
    title: "Konfirmasi Reject Absensi",   
    text: "Apakah Anda Akan Mereject Absensi Ini?",   
    type: "warning",   
    ...
    if (isConfirm) {
      ...
      url_edit = '<?php echo base_url()?>index.php/data_absensi/reject_absensi/'+id,
						$.getJSON(url_edit, function (data){
						sweetAlert({
	                                                   title: "Berhasil!", 
