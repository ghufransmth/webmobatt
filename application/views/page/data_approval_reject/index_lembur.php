    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
           ...
           <li class="active">Data Lembur Sudah Disetujui </li>
          </ol>
        </section>
	...
	<script>
		$(document).ready(function(){ 
			$("#data-brands").dataTable({
					...
					"bAutoWidth": false,
					"processing": true,
					"ajax": '<?php echo base_url() ?>/index.php/data_overtime/get_data_overtime_approval_reject',
					"columns": [
    ...
    text: "Apakah Anda Akan Menyetujui Reject Ini?",   
    type: "warning",   
    ...
    if (isConfirm) {
      ...
      url_edit = '<?php echo base_url()?>index.php/data_overtime/approval_reject/'+id,
						$.getJSON(url_edit, function (data){
						sweetAlert({
	                                                   title: "Berhasil!", 
