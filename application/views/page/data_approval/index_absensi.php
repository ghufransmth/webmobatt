    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            DATA ABSENSI UNTUK DISETUJUI
          </h1>
          <ol class="breadcrumb">
             <li><a href="<?php echo base_url() ?>index.php/home"><i class="fa fa-home"></i> Home</a></li>
           <li class="active">Data Absensi Untuk Disetujui </li>
          </ol>
        </section>
	...
	<script>
		$(document).ready(function(){ 
			$("#data-brands").dataTable({
					...
					"bAutoWidth": false,
					"processing": true,
					"ajax": '<?php echo base_url() ?>/index.php/data_absensi/get_data_absensi_approval',
					"columns": [
    ...
    if (isConfirm) {
       ...
       url_edit = '<?php echo base_url()?>index.php/data_absensi/reject_absensi2/'+id,
