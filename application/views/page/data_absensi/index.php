			...
			<div class="row">
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-body">
								<form action="<?php echo base_url() ?>index.php/data_absensi/search_absen" method="POST">
							...
							<div  style="width:100%;overflow:scroll">
								...
								<thead>
								<tr>
									<td rowspan="2" style="text-align:center;background-color:#18365E;color:white;border:1px solid #FFD700">Nama Pegawai</td>
