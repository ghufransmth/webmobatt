					 ...
					 <div ><br />
						<img src=\"".base_url()."assets/dist/img/mandiri_oke.png\" style='width:300px;height:100px'>
						 ...
						 <div  style=\"text-align:center\">
							<h2 style='font-size:19px'><b>REKAP DATA IJIN</b></h2>
						 </div>
						<div  style=\"width:100%;height:120px\">
							...
							";
								...
								//foreach($data as $val){
									...
									<table style='text-align:center;border-collapse: collapse;width:100%;border=1; ' border ='1'>
											...
											<tr>
												<td style='height:25px;width:200px'>Tanggal Mulai Ijin</td>
												<td style='width:200px'>Tanggal Selesai Ijin</td>
												<td style='width:330px'>Alasan</td>
										...
										foreach($data as $val){
											$content .="
												<tr>
													<td style='height:20px'>".$val['tanggal_mulai']."</td>
													<td>".$val['tanggal_selesai']."</td>
													<td>".$val['data_ijin_list'][0]['reason_desc']."</td>
							...
							<tr>
								...
								<td>:</td>
								<td style='font-size:12px'>RP-IJN-$bulan-$tahun</td>
							</tr>
