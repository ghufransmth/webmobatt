					 ...
					 <div ><br />
						<img src=\"".base_url()."assets/dist/img/mandiri_oke.png\" style='width:300px;height:100px'>
						 ...
						 <div  style=\"text-align:center\">
							<h2 style='font-size:19px'><b>REKAP DATA LEMBUR</b></h2>
						 </div>
							...
							";
								...
								//foreach($data as $val){
									...
									<table style='text-align:center;border-collapse: collapse;width:100%;border=1; ' border ='1'>
											...
											<tr>
												<td style='height:25px;width:340px;'>Tanggal </td>
												<td style='width:200px'>Jam Masuk</td>
												<td style='width:200px'>Jam Keluar</td>
										...
										foreach($data as $val){
											$content .="
												<tr>
													<td style='height:20px'>".$val['date']."</td>
