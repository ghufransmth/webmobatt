...
<div class="login-box">
		...
		<div class="clear"> </div>
		<div class="btn">
			<input type="submit" value="LOG IN" ><br /><div style="color:white">
			<a href="http://rekrutmen.bankmantap.co.id" style="color:white">Register</a>||<a href="<?php echo base_url(); ?>/index.php/login/forgot" style="color:white">Forgot Password</a></div>
		</div>
</form>
