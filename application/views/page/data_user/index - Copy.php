		...
		$(document).ready(function(){ 
			$("#data-brands").dataTable({
					...
					"columns": [
						...
						{ "data": "id", 
						"render" : function(data){
							return '<a href="<?php echo base_url()?>index.php/data_user/view_edit_data_user/'+data+'"><button type="button" class="btn btn-success btn-sm"   style="border-radius:0px;" ><i class="fa fa-pencil-square-o"></i></button></a>'
						}}
