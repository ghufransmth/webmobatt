						...
						<div class="box-body">
							...
							<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" name="kode" value="<?php echo $kode; ?>" class="form-control" id="" required>
											<div id="code_accessoris_val" ></div>
									</div>
									
									<div class="form-group">
										<label for="exampleInputEmail1">Nama Unit Kerja</label>
										<input type="text" name="nama_unit_kerja" value="<?php echo $nama_unit_kerja; ?>" class="form-control" id="" required>
											<div id="code_accessoris_val" ></div>
									</div>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_master/edit_data_master_unit_kerja',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
