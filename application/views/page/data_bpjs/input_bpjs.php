    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Input Data BPJS </li>
          </ol>
        </section>
        <!-- Main content -->
						...
						<div class="box-body">
							...
							<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="file" name="file_bpjs" id="file_bpjs" class="form-control" required>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_bpjs/save_data_bpjs',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
