						...
						<div class="box-body">
							...
							<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" name="nama_jabatan" class="form-control" id="" required>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_master/save_data_master_jabatan',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
