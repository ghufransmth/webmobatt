			...
			<div class="row">
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-body">
							<h3 class="box-title">
								<a class="btn btn-primary " href="<?php echo base_url(); ?>index.php/data_master/input_master_data_jabatan" role="button" style="color:white"><i class="fa fa-plus-circle fa-1x"></i> &nbsp;&nbsp;Tambah Jabatan</a>
							</h3>
	...
	<script>
		$(document).ready(function(){ 
			$("#data-brands").dataTable({
					...
					"bAutoWidth": false,
					"processing": true,
					"ajax": '<?php echo base_url() ?>/index.php/data_master/get_data_jabatan',
					"columns": [
						{ "data": "nama_jabatan" },
    ...
    if (isConfirm) {
     ...
     url_edit = '<?php echo base_url()?>index.php/data_master/delete_master_jabatan/'+id,
