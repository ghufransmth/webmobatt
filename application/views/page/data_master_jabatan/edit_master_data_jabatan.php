    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo base_url(); ?>/index.php/data_master/index_master_jabatan"><i class="fa fa-gift"></i> Data Master Jabatan </a></li>
				...
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-body">
							...
							<div class="col-md-6">
									<input type="hidden" name="id_jabatan" value="<?php echo $id_jabatan; ?>"class="form-control" id="user_id" >
										
									<div class="form-group">
										<label for="exampleInputEmail1">Nama Jabatan</label>
										<input type="text" value="<?php echo $nama_jabatan; ?>" name="nama_jabatan" class="form-control" id="" required>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_master/edit_data_master_jabatan',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
					...
					success:function (data){
							...
							sweetAlert({
	                                                   title: "Berhasil!", 
														...
														, function() {
																	location.href='<?php echo base_url(); ?>index.php/data_master/index_master_jabatan';
														}
														);
