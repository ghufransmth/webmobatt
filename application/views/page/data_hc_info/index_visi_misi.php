						 ...
						 <?php
							...
							<div class="col-md-12">
								...
								<div class="form-group">
										 <textarea name="visi_misi" class="textarea" id="content" rows="10" style="width:100%"><?php echo $visi_misi; ?></textarea>
									</div>
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_hc_info/save_data_visi_misi',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
					...
					success:function (data){
							...
							sweetAlert({
	                                                   title: "Berhasil!", 
														...
														, function() {
																	location.href='<?php echo base_url(); ?>index.php/data_hc_info/index_visi_misi';
														}
														);
