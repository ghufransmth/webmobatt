						 ...
						 <?php
							...
							<div class="col-md-12">
								...
								<div class="form-group">
										<label for="exampleInputEmail1">Upload Struktur Organisasi</label>
							...
							<table class="table table-bordered" style="text-align:center">
								<tr>
									<td><a  class="media" href="<?php echo base_url(); ?>/upload/upload_struktur/<?php echo $nama_file; ?>" target="_blank"></td>
								</tr>
								<tr>
									<td><a  class="" href="<?php echo base_url(); ?>/upload/upload_struktur/<?php echo $nama_file; ?>" target="_blank">Download</td>
								</tr>
							</table>
							<?php
							}else{
...
<script>
	$('#form_input_shoes').submit(function(e){
		...
		formData = new FormData($(this)[0]);
			$.ajax({
					url 	: '<?php echo base_url() ?>/index.php/data_hc_info/save_data_struktur_organisasi',
					type	: 'POST',
					data	: formData,
					async	: false,
					cache	: false,
					...
					success:function (data){
							...
							sweetAlert({
	                                                   title: "Berhasil!", 
														...
														, function() {
																	location.href='<?php echo base_url(); ?>index.php/data_hc_info/index_struktur';
														}
														);
